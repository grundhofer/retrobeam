/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d2195e9fa046fe3e145c934488674a4a)
// Runtime types generated with workerd@1.20260710.1 2026-07-01 
interface __BaseEnv_Env {
	CREATE_LIMITER: RateLimit;
	GIF_LIMITER: RateLimit;
	KLIPY_API_KEY: string;
	GIF_HOST_SUFFIX: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "BoardRoom" | "RateLimiter";
	}
