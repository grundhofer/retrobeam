...
export function ErrorBoundary() {
  ...
  return (
    <div
      className="flex min-h-dvh flex-col items-center justify-center gap-4 bg-zinc-50 px-6 text-center"
    ...
    >
      ...
      <p className="max-w-prose font-mono text-xs break-all text-zinc-400">
        {detail}
      </p>
    </div>
  );
